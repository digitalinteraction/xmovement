            ...
            <div class="auth-panel">
                    ...
                    <form class="auth-form" role="form" method="POST" action="{{ url('/details') }}">
                        ...
                        <div class="form-group{{ $errors->has('bio') ? ' has-error' : '' }}">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="bio" value="{{ old('bio') }}" placeholder="Say something about yourself">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="Your phone number">
